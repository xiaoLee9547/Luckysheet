                    ...
                    let itemdata = [
                        {
                            ...
                            value: "areas",
                            example: '<i class="iconfont-luckysheet luckysheet-iconfont-dayinquyu" style="line-height: 18px;" aria-hidden="true"></i>',
                        },
                        {text: "", value: "split", example: ""},
                        {
                            text: locale_print.menuItemPrint,
                            value: "sheet",
                            example: '<i class="iconfont-luckysheet luckysheet-iconfont-dayin" style="line-height: 18px;" aria-hidden="true"></i>',
                        },
                        {text: "", value: "split", example: ""},
                        {
                            text: locale_print.printAllSheets,
                            value: "workbook",
                            example: '<i class="iconfont-luckysheet luckysheet-iconfont-dayinyemianpeizhi" style="line-height: 18px;" aria-hidden="true"></i>',
                        },
                    ];
